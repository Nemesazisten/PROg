...
MODULE_DESCRIPTION ("Az első kernel modulom:)");
MODULE_AUTHOR (Bátfai Norert (nbatfai@gmail.com");
MODULE_LICENSE ("GPL);
...
printk (KERN_NOTICE "Belép az 1. modulba\n");
list_for_each (p; current->tasks.next) {
task = list_entry (p, struct tasks_struct, tasks);
